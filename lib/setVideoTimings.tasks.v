...
task setVideoVidACTIVEwOS;
  ...
  begin
    case (video_config)
      `USE_240p60: begin  // 240p-60, 4:3 (2x/4x pixelrep, mode 2)
          VACTIVE_OS <= `VACTIVE_240p60 + 2*`VOVERSCAN_MAX;
          HACTIVE_OS <= `HACTIVE_240p60 + 2*`HOVERSCAN_MAX;
        end
      `USE_VGAp60: begin  // VGA-60 (640x480), 4:3
          VACTIVE_OS <= `VACTIVE_VGAp60 + 2*`VOVERSCAN_MAX;
          HACTIVE_OS <= `HACTIVE_VGAp60 + 2*`HOVERSCAN_MAX;
        end
      `USE_480p60: begin  // 480p-60, 4:3 / 16:9
            VACTIVE_OS <= `VACTIVE_480p60 + 2*`VOVERSCAN_MAX;
            HACTIVE_OS <= `HACTIVE_480p60 + 2*`HOVERSCAN_MAX;
        end
      `USE_720p60: begin  // 720p-60, 16:9
          VACTIVE_OS <= `VACTIVE_720p60 + 2*`VOVERSCAN_MAX;
          HACTIVE_OS <= `HACTIVE_720p60 + 2*`HOVERSCAN_MAX;
        end
      `USE_960p60: begin  // 960p-60, 4:3
          VACTIVE_OS <= `VACTIVE_960p60 + 2*`VOVERSCAN_MAX;
          HACTIVE_OS <= `HACTIVE_960p60 + 2*`HOVERSCAN_MAX;
        end
//      `USE_1080p60: begin // 1080p-60, 16:9
//          VACTIVE_OS <= `VACTIVE_1080p60 + 2*`VOVERSCAN_MAX;
//          HACTIVE_OS <= `HACTIVE_1080p60 + 2*`HOVERSCAN_MAX;
//        end
      `USE_1200p60: begin // 1200p-60, 4:3
          VACTIVE_OS <= `VACTIVE_1200p60 + 2*`VOVERSCAN_MAX;
          HACTIVE_OS <= `HACTIVE_1200p60 + 2*`HOVERSCAN_MAX;
        end
      `USE_1440p60: begin // 1440p-60, 4:3
          VACTIVE_OS <= `VACTIVE_1440p60 + 2*`VOVERSCAN_MAX;
          HACTIVE_OS <= `HACTIVE_1440p60 + 2*`HOVERSCAN_MAX;
        end
      `USE_1440Wp60: begin  // 1440p-60, 16:9 (2x pixelrep)
          VACTIVE_OS <= `VACTIVE_1440Wp60 + 2*`VOVERSCAN_MAX;
          HACTIVE_OS <= `HACTIVE_1440Wp60 + 2*`HOVERSCAN_MAX;
        end
      `USE_288p50: begin  // 288p-50, 4:3 (2x/4x pixelrep, mode 2)
          VACTIVE_OS <= `VACTIVE_288p50 + 2*`VOVERSCAN_MAX;
          HACTIVE_OS <= `HACTIVE_288p50 + 2*`HOVERSCAN_MAX;
        end
      `USE_VGAp50: begin  // VGAp-50, 4:3 / 16:9
            VACTIVE_OS <= `VACTIVE_VGAp50 + 2*`VOVERSCAN_MAX;
            HACTIVE_OS <= `HACTIVE_VGAp50 + 2*`HOVERSCAN_MAX;
        end
      `USE_576p50: begin  // 576p-50, 4:3 / 16:9
            VACTIVE_OS <= `VACTIVE_576p50 + 2*`VOVERSCAN_MAX;
            HACTIVE_OS <= `HACTIVE_576p50 + 2*`HOVERSCAN_MAX;
        end
      `USE_720p50: begin  // 720p-50, 16:9
          VACTIVE_OS <= `VACTIVE_720p50 + 2*`VOVERSCAN_MAX;
          HACTIVE_OS <= `HACTIVE_720p50 + 2*`HOVERSCAN_MAX;
        end
      `USE_960p50: begin  // 960p-50, 4:3
          VACTIVE_OS <= `VACTIVE_960p50 + 2*`VOVERSCAN_MAX;
          HACTIVE_OS <= `HACTIVE_960p50 + 2*`HOVERSCAN_MAX;
        end
      `USE_1080p50: begin // 1080p-50, 16:9
          VACTIVE_OS <= `VACTIVE_1080p50 + 2*`VOVERSCAN_MAX;
          HACTIVE_OS <= `HACTIVE_1080p50 + 2*`HOVERSCAN_MAX;
        end
      `USE_1200p50: begin // 1200p-50, 4:3
          VACTIVE_OS <= `VACTIVE_1200p50 + 2*`VOVERSCAN_MAX;
          HACTIVE_OS <= `HACTIVE_1200p50 + 2*`HOVERSCAN_MAX;
        end
      `USE_1440p50: begin // 1440p-50, 4:3
          VACTIVE_OS <= `VACTIVE_1440p50 + 2*`VOVERSCAN_MAX;
          HACTIVE_OS <= `HACTIVE_1440p50 + 2*`HOVERSCAN_MAX;
        end
      `USE_1440Wp50: begin  // 1440p-50, 16:9 (2x pixelrep)
          VACTIVE_OS <= `VACTIVE_1440Wp50 + 2*`VOVERSCAN_MAX;
          HACTIVE_OS <= `HACTIVE_1440Wp50 + 2*`HOVERSCAN_MAX;
        end
      default: begin  // 1080p-60, 16:9
          VACTIVE_OS <= `VACTIVE_1080p60 + 2*`VOVERSCAN_MAX;
          HACTIVE_OS <= `HACTIVE_1080p60 + 2*`HOVERSCAN_MAX;
  ...
  begin
    case (video_config)
      `USE_240p60: begin  // 240p-60, 4:3 (2x/4x pixelrep, mode 2)
          ...
          VSTART_OS <= `VSYNCLEN_240p60 + `VBACKPORCH_240p60 - `VOVERSCAN_MAX;
          VACTIVE_OS <= `VACTIVE_240p60 + 2*`VOVERSCAN_MAX;
          VSTOP_OS <= `VSYNCLEN_240p60 + `VBACKPORCH_240p60 + `VACTIVE_240p60 + `VOVERSCAN_MAX;
      ...
      `USE_VGAp60: begin  // VGA-60 (640x480), 4:3
          ...
          VSTART_OS <= `VSYNCLEN_VGAp60 + `VBACKPORCH_VGAp60 - `VOVERSCAN_MAX;
          VACTIVE_OS <= `VACTIVE_VGAp60 + 2*`VOVERSCAN_MAX;
          VSTOP_OS <= `VSYNCLEN_VGAp60 + `VBACKPORCH_VGAp60 + `VACTIVE_VGAp60 + `VOVERSCAN_MAX;
      ...
      `USE_480p60: begin  // 480p-60, 4:3 / 16:9
          ...
          VSTART_OS <= `VSYNCLEN_480p60 + `VBACKPORCH_480p60 - `VOVERSCAN_MAX;
          VACTIVE_OS <= `VACTIVE_480p60 + 2*`VOVERSCAN_MAX;
          VSTOP_OS <= `VSYNCLEN_480p60 + `VBACKPORCH_480p60 + `VACTIVE_480p60 + `VOVERSCAN_MAX;
      ...
      `USE_720p60: begin  // 720p-60, 16:9
          ...
          VSTART_OS <= `VSYNCLEN_720p60 + `VBACKPORCH_720p60 - `VOVERSCAN_MAX;
          VACTIVE_OS <= `VACTIVE_720p60 + 2*`VOVERSCAN_MAX;
          VSTOP_OS <= `VSYNCLEN_720p60 + `VBACKPORCH_720p60 + `VACTIVE_720p60 + `VOVERSCAN_MAX;
      ...
      `USE_960p60: begin  // 960p-60, 4:3
          ...
          VSTART_OS <= `VSYNCLEN_960p60 + `VBACKPORCH_960p60 - `VOVERSCAN_MAX;
          VACTIVE_OS <= `VACTIVE_960p60 + 2*`VOVERSCAN_MAX;
          VSTOP_OS <= `VSYNCLEN_960p60 + `VBACKPORCH_960p60 + `VACTIVE_960p60 + `VOVERSCAN_MAX;
...
//          VSTART_OS <= `VSYNCLEN_1080p60 + `VBACKPORCH_1080p60 - `VOVERSCAN_MAX;
//          VACTIVE_OS <= `VACTIVE_1080p60 + 2*`VOVERSCAN_MAX;
//          VSTOP_OS <= `VSYNCLEN_1080p60 + `VBACKPORCH_1080p60 + `VACTIVE_1080p60 + `VOVERSCAN_MAX;
...
//        end
      `USE_1200p60: begin // 1200p-60, 4:3
          ...
          VSTART_OS <= `VSYNCLEN_1200p60 + `VBACKPORCH_1200p60 - `VOVERSCAN_MAX;
          VACTIVE_OS <= `VACTIVE_1200p60 + 2*`VOVERSCAN_MAX;
          VSTOP_OS <= `VSYNCLEN_1200p60 + `VBACKPORCH_1200p60 + `VACTIVE_1200p60 + `VOVERSCAN_MAX;
      ...
      `USE_1440p60: begin // 1440p-60, 4:3
          ...
          VSTART_OS <= `VSYNCLEN_1440p60 + `VBACKPORCH_1440p60 - `VOVERSCAN_MAX;
          VACTIVE_OS <= `VACTIVE_1440p60 + 2*`VOVERSCAN_MAX;
          VSTOP_OS <= `VSYNCLEN_1440p60 + `VBACKPORCH_1440p60 + `VACTIVE_1440p60 + `VOVERSCAN_MAX;
      ...
      `USE_1440Wp60: begin  // 1440p-60, 16:9 (2x pixelrep)
          ...
          VSTART_OS <= `VSYNCLEN_1440Wp60 + `VBACKPORCH_1440Wp60 - `VOVERSCAN_MAX;
          VACTIVE_OS <= `VACTIVE_1440Wp60 + 2*`VOVERSCAN_MAX;
          VSTOP_OS <= `VSYNCLEN_1440Wp60 + `VBACKPORCH_1440Wp60 + `VACTIVE_1440Wp60 + `VOVERSCAN_MAX;
      ...
      `USE_288p50: begin  // 288p-50, 4:3 (2x/4x pixelrep, mode 2)
          ...
          VSTART_OS <= `VSYNCLEN_288p50 + `VBACKPORCH_288p50 - `VOVERSCAN_MAX;
          VACTIVE_OS <= `VACTIVE_288p50 + 2*`VOVERSCAN_MAX;
          VSTOP_OS <= `VSYNCLEN_288p50 + `VBACKPORCH_288p50 + `VACTIVE_288p50 + `VOVERSCAN_MAX;
      ...
      `USE_VGAp50: begin  // VGA-50, 4:3
            ...
            VSTART_OS <= `VSYNCLEN_VGAp50 + `VBACKPORCH_VGAp50 - `VOVERSCAN_MAX;
            VACTIVE_OS <= `VACTIVE_VGAp50 + 2*`VOVERSCAN_MAX;
            VSTOP_OS <= `VSYNCLEN_VGAp50 + `VBACKPORCH_VGAp50 + `VACTIVE_VGAp50 + `VOVERSCAN_MAX;
      ...
      `USE_576p50: begin  // 576p-50, 4:3 / 16:9
            ...
            VSTART_OS <= `VSYNCLEN_576p50 + `VBACKPORCH_576p50 - `VOVERSCAN_MAX;
            VACTIVE_OS <= `VACTIVE_576p50 + 2*`VOVERSCAN_MAX;
            VSTOP_OS <= `VSYNCLEN_576p50 + `VBACKPORCH_576p50 + `VACTIVE_576p50 + `VOVERSCAN_MAX;
      ...
      `USE_720p50: begin  // 720p-50, 16:9
          ...
          VSTART_OS <= `VSYNCLEN_720p50 + `VBACKPORCH_720p50 - `VOVERSCAN_MAX;
          VACTIVE_OS <= `VACTIVE_720p50 + 2*`VOVERSCAN_MAX;
          VSTOP_OS <= `VSYNCLEN_720p50 + `VBACKPORCH_720p50 + `VACTIVE_720p50 + `VOVERSCAN_MAX;
      ...
      `USE_960p50: begin  // 960p-50, 4:3
          ...
          VSTART_OS <= `VSYNCLEN_960p50 + `VBACKPORCH_960p50 - `VOVERSCAN_MAX;
          VACTIVE_OS <= `VACTIVE_960p50 + 2*`VOVERSCAN_MAX;
          VSTOP_OS <= `VSYNCLEN_960p50 + `VBACKPORCH_960p50 + `VACTIVE_960p50 + `VOVERSCAN_MAX;
      ...
      `USE_1080p50: begin // 1080p-50, 16:9
          ...
          VSTART_OS <= `VSYNCLEN_1080p50 + `VBACKPORCH_1080p50 - `VOVERSCAN_MAX;
          VACTIVE_OS <= `VACTIVE_1080p50 + 2*`VOVERSCAN_MAX;
          VSTOP_OS <= `VSYNCLEN_1080p50 + `VBACKPORCH_1080p50 + `VACTIVE_1080p50 + `VOVERSCAN_MAX;
      ...
      `USE_1200p50: begin // 1200p-50, 4:3
          ...
          VSTART_OS <= `VSYNCLEN_1200p50 + `VBACKPORCH_1200p50 - `VOVERSCAN_MAX;
          VACTIVE_OS <= `VACTIVE_1200p50 + 2*`VOVERSCAN_MAX;
          VSTOP_OS <= `VSYNCLEN_1200p50 + `VBACKPORCH_1200p50 + `VACTIVE_1200p50 + `VOVERSCAN_MAX;
      ...
      `USE_1440p50: begin // 1440p-50, 4:3
          ...
          VSTART_OS <= `VSYNCLEN_1440p50 + `VBACKPORCH_1440p50 - `VOVERSCAN_MAX;
          VACTIVE_OS <= `VACTIVE_1440p50 + 2*`VOVERSCAN_MAX;
          VSTOP_OS <= `VSYNCLEN_1440p50 + `VBACKPORCH_1440p50 + `VACTIVE_1440p50 + `VOVERSCAN_MAX;
      ...
      `USE_1440Wp50: begin // 1440p-50, 16:9 (2x pixelrep)
          ...
          VSTART_OS <= `VSYNCLEN_1440Wp50 + `VBACKPORCH_1440Wp50 - `VOVERSCAN_MAX;
          VACTIVE_OS <= `VACTIVE_1440Wp50 + 2*`VOVERSCAN_MAX;
          VSTOP_OS <= `VSYNCLEN_1440Wp50 + `VBACKPORCH_1440Wp50 + `VACTIVE_1440Wp50 + `VOVERSCAN_MAX;
  ...
  begin
    case (video_config)
      `USE_240p60: begin  // 240p-60, 4:3 (2x/4x pixelrep, mode 2)
          ...
          HSTART_OS <= `HSYNCLEN_240p60 + `HBACKPORCH_240p60 - `HOVERSCAN_MAX;
          HACTIVE_OS <= `HACTIVE_240p60 + 2*`HOVERSCAN_MAX;
          HSTOP_OS <= `HSYNCLEN_240p60 + `HBACKPORCH_240p60 + `HACTIVE_240p60 + `HOVERSCAN_MAX;
      ...
      `USE_VGAp60: begin  // VGA-60 (640x480), 4:3
          ...
          HSTART_OS <= `HSYNCLEN_VGAp60 + `HBACKPORCH_VGAp60 - `HOVERSCAN_MAX;
          HACTIVE_OS <= `HACTIVE_VGAp60 + 2*`HOVERSCAN_MAX;
          HSTOP_OS <= `HSYNCLEN_VGAp60 + `HBACKPORCH_VGAp60 + `HACTIVE_VGAp60 + `HOVERSCAN_MAX;
      ...
      `USE_480p60: begin  // 480p-60, 4:3 / 16:9
          ...
          HSTART_OS <= `HSYNCLEN_480p60 + `HBACKPORCH_480p60 - `HOVERSCAN_MAX;
          HACTIVE_OS <= `HACTIVE_480p60 + 2*`HOVERSCAN_MAX;
          HSTOP_OS <= `HSYNCLEN_480p60 + `HBACKPORCH_480p60 + `HACTIVE_480p60 + `HOVERSCAN_MAX;
      ...
      `USE_720p60: begin  // 720p-60, 16:9
          ...
          HSTART_OS <= `HSYNCLEN_720p60 + `HBACKPORCH_720p60 - `HOVERSCAN_MAX;
          HACTIVE_OS <= `HACTIVE_720p60 + 2*`HOVERSCAN_MAX;
          HSTOP_OS <= `HSYNCLEN_720p60 + `HBACKPORCH_720p60 + `HACTIVE_720p60 + `HOVERSCAN_MAX;
      ...
      `USE_960p60: begin  // 960p-60, 4:3
          ...
          HSTART_OS <= `HSYNCLEN_960p60 + `HBACKPORCH_960p60 - `HOVERSCAN_MAX;
          HACTIVE_OS <= `HACTIVE_960p60 + 2*`HOVERSCAN_MAX;
          HSTOP_OS <= `HSYNCLEN_960p60 + `HBACKPORCH_960p60 + `HACTIVE_960p60 + `HOVERSCAN_MAX;
...
//          HSTART_OS <= `HSYNCLEN_1080p60 + `HBACKPORCH_1080p60 - `HOVERSCAN_MAX;
//          HACTIVE_OS <= `HACTIVE_1080p60 + 2*`HOVERSCAN_MAX;
//          HSTOP_OS <= `HSYNCLEN_1080p60 + `HBACKPORCH_1080p60 + `HACTIVE_1080p60 + `HOVERSCAN_MAX;
...
//        end
      `USE_1200p60: begin // 1200p-60, 4:3
          ...
          HSTART_OS <= `HSYNCLEN_1200p60 + `HBACKPORCH_1200p60 - `HOVERSCAN_MAX;
          HACTIVE_OS <= `HACTIVE_1200p60 + 2*`HOVERSCAN_MAX;
          HSTOP_OS <= `HSYNCLEN_1200p60 + `HBACKPORCH_1200p60 + `HACTIVE_1200p60 + `HOVERSCAN_MAX;
      ...
      `USE_1440p60: begin // 1440p-60, 4:3
          ...
          HSTART_OS <= `HSYNCLEN_1440p60 + `HBACKPORCH_1440p60 - `HOVERSCAN_MAX;
          HACTIVE_OS <= `HACTIVE_1440p60 + 2*`HOVERSCAN_MAX;
          HSTOP_OS <= `HSYNCLEN_1440p60 + `HBACKPORCH_1440p60 + `HACTIVE_1440p60 + `HOVERSCAN_MAX;
      ...
      `USE_1440Wp60: begin  // 1440p-60, 16:9 (2x pixelrep)
          ...
          HSTART_OS <= `HSYNCLEN_1440Wp60 + `HBACKPORCH_1440Wp60 - `HOVERSCAN_MAX;
          HACTIVE_OS <= `HACTIVE_1440Wp60 + 2*`HOVERSCAN_MAX;
          HSTOP_OS <= `HSYNCLEN_1440Wp60 + `HBACKPORCH_1440Wp60 + `HACTIVE_1440Wp60 + `HOVERSCAN_MAX;
      ...
      `USE_288p50: begin // 288p-50, 4:3 (2x/4x pixelrep, mode 2)
          ...
          HSTART_OS <= `HSYNCLEN_288p50 + `HBACKPORCH_288p50 - `HOVERSCAN_MAX;
          HACTIVE_OS <= `HACTIVE_288p50 + 2*`HOVERSCAN_MAX;
          HSTOP_OS <= `HSYNCLEN_288p50 + `HBACKPORCH_288p50 + `HACTIVE_288p50 + `HOVERSCAN_MAX;
      ...
      `USE_VGAp50: begin  // VGA-50 (640x576), 4:3
          ...
          HSTART_OS <= `HSYNCLEN_VGAp50 + `HBACKPORCH_VGAp50 - `HOVERSCAN_MAX;
          HACTIVE_OS <= `HACTIVE_VGAp50 + 2*`HOVERSCAN_MAX;
          HSTOP_OS <= `HSYNCLEN_VGAp50 + `HBACKPORCH_VGAp50 + `HACTIVE_VGAp50 + `HOVERSCAN_MAX;
      ...
      `USE_576p50: begin  // 576p-50, 4:3 / 16:9
          ...
          HSTART_OS <= `HSYNCLEN_576p50 + `HBACKPORCH_576p50 - `HOVERSCAN_MAX;
          HACTIVE_OS <= `HACTIVE_576p50 + 2*`HOVERSCAN_MAX;
          HSTOP_OS <= `HSYNCLEN_576p50 + `HBACKPORCH_576p50 + `HACTIVE_576p50 + `HOVERSCAN_MAX;
      ...
      `USE_720p50: begin  // 720p-50, 16:9
          ...
          HSTART_OS <= `HSYNCLEN_720p50 + `HBACKPORCH_720p50 - `HOVERSCAN_MAX;
          HACTIVE_OS <= `HACTIVE_720p50 + 2*`HOVERSCAN_MAX;
          HSTOP_OS <= `HSYNCLEN_720p50 + `HBACKPORCH_720p50 + `HACTIVE_720p50 + `HOVERSCAN_MAX;
      ...
      `USE_960p50: begin  // 960p-50, 4:3
          ...
          HSTART_OS <= `HSYNCLEN_960p50 + `HBACKPORCH_960p50 - `HOVERSCAN_MAX;
          HACTIVE_OS <= `HACTIVE_960p50 + 2*`HOVERSCAN_MAX;
          HSTOP_OS <= `HSYNCLEN_960p50 + `HBACKPORCH_960p50 + `HACTIVE_960p50 + `HOVERSCAN_MAX;
      ...
      `USE_1080p50: begin // 1080p-50, 16:9
          ...
          HSTART_OS <= `HSYNCLEN_1080p50 + `HBACKPORCH_1080p50 - `HOVERSCAN_MAX;
          HACTIVE_OS <= `HACTIVE_1080p50 + 2*`HOVERSCAN_MAX;
          HSTOP_OS <= `HSYNCLEN_1080p50 + `HBACKPORCH_1080p50 + `HACTIVE_1080p50 + `HOVERSCAN_MAX;
      ...
      `USE_1200p50: begin // 1200p-50, 4:3
          ...
          HSTART_OS <= `HSYNCLEN_1200p50 + `HBACKPORCH_1200p50 - `HOVERSCAN_MAX;
          HACTIVE_OS <= `HACTIVE_1200p50 + 2*`HOVERSCAN_MAX;
          HSTOP_OS <= `HSYNCLEN_1200p50 + `HBACKPORCH_1200p50 + `HACTIVE_1200p50 + `HOVERSCAN_MAX;
      ...
      `USE_1440p50: begin // 1440p-50, 4:3
          ...
          HSTART_OS <= `HSYNCLEN_1440p50 + `HBACKPORCH_1440p50 - `HOVERSCAN_MAX;
          HACTIVE_OS <= `HACTIVE_1440p50 + 2*`HOVERSCAN_MAX;
          HSTOP_OS <= `HSYNCLEN_1440p50 + `HBACKPORCH_1440p50 + `HACTIVE_1440p50 + `HOVERSCAN_MAX;
      ...
      `USE_1440Wp50: begin  // 1440p-50, 16:9 (2x pixelrep)
          ...
          HSTART_OS <= `HSYNCLEN_1440Wp50 + `HBACKPORCH_1440Wp50 - `HOVERSCAN_MAX;
          HACTIVE_OS <= `HACTIVE_1440Wp50 + 2*`HOVERSCAN_MAX;
          HSTOP_OS <= `HSYNCLEN_1440Wp50 + `HBACKPORCH_1440Wp50 + `HACTIVE_1440Wp50 + `HOVERSCAN_MAX;
