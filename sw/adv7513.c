...
//{
//  adv7513_reg_bitclear(ADV7513_REG_VIDEO_INPUT_CFG2,1); // set 4:3 aspect ratio of input video
////  adv7513_writereg(ADV7513_REG_VIC_MANUAL, 8);
////  if (palmode == NTSC) { // NTSC
////    switch (linemult_mode) {
////      case PASSTHROUGH:
////        set_pr_manual(2);
////        if (scanmode == PROGRESSIVE) {
//////          set_vclk_div(4);
////          set_vclk_div(2);
////          adv7513_writereg(ADV7513_REG_VIC_MANUAL, 8);  // 001000 = VIC#8: 240p-60, 2x Clk, 4:3
////        } else {
////          set_vclk_div(2);
////          adv7513_writereg(ADV7513_REG_VIC_MANUAL, 6);  // 000110 = VIC#6: 480i-60, 2x Clk, 4:3
////        }
////        break;
////      case LINEX2:
////        set_pr_manual(2);
////        set_vclk_div(0);
////        adv7513_writereg(ADV7513_REG_VIC_MANUAL, 14); // 001110 = VIC#14: 480p-60, 2x Clk, 4:3
////        break;
////      case LINEX3:
//        set_pr_manual(0);
//        set_vclk_div(0);
//        adv7513_writereg(ADV7513_REG_VIC_MANUAL, 4); // 000100 = VIC#4: 720p-60, 16:9
////        break;
////      default: break;
////    }
////  } else { // PAL
...
//////          set_vclk_div(4);
////          set_vclk_div(2);
////          adv7513_writereg(ADV7513_REG_VIC_MANUAL, 23); // 010111 = VIC#23: 288p-50, 2x Clk, 4:3
////        } else {
////          set_vclk_div(2);
////          adv7513_writereg(ADV7513_REG_VIC_MANUAL, 21); // 010101 = VIC#21: 576i-50, 2x Clk, 4:3
////        }
////        break;
////      case LINEX2:
////        set_pr_manual(2);
////        set_vclk_div(2);
////        adv7513_writereg(ADV7513_REG_VIC_MANUAL, 17); // 010001 = VIC#17: 576p-50, 4:3
//////        set_vclk_div(0);
//////        adv7513_writereg(ADV7513_REG_VIC_MANUAL, 29); // 011101 = VIC#29: 576p-50, 2x Clk, 4:3
////        break;
////      case LINEX3:
////      default:
////        set_pr_manual(0);
////        set_vclk_div(0);
////        adv7513_writereg(ADV7513_REG_VIC_MANUAL, 0); // 000000 = VIC#0: VIC Unavailable
////        break;
////    }
////
////  }
