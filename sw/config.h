...
#define CFG_RESOLUTION_GETMASK        (0x7<<CFG_RESOLUTION_OFFSET)
  #define CFG_RESOLUTION_1200_SETMASK   (4<<CFG_RESOLUTION_OFFSET)
  #define CFG_RESOLUTION_1080_SETMASK   (3<<CFG_RESOLUTION_OFFSET)
  #define CFG_RESOLUTION_960_SETMASK    (2<<CFG_RESOLUTION_OFFSET)
  #define CFG_RESOLUTION_720_SETMASK    (1<<CFG_RESOLUTION_OFFSET)
  #define CFG_RESOLUTION_480_SETMASK    (0<<CFG_RESOLUTION_OFFSET)
...
#define CFG_AUDIO_AMP_OFFSET        27
#define CFG_AUDIO_SWAP_LR_OFFSET    26
#define CFG_AUDIO_SPDIF_EN_OFFSET   25
...
#define CFG_240P_SL_METHOD_GETMASK    (1<<CFG_240P_SL_METHOD_OFFSET)
  ...
  #define CFG_240P_SL_METHOD_CLRMASK    (EXTCFG2_GETALL_MASK & ~CFG_240P_SL_METHOD_SETMASK)
#define CFG_240P_SL_ID_GETMASK        (1<<CFG_240P_SL_ID_OFFSET)
  #define CFG_240P_SL_ID_SETMASK        (1<<CFG_240P_SL_ID_OFFSET)
  #define CFG_240P_SL_ID_CLRMASK        (EXTCFG2_GETALL_MASK & ~CFG_240P_SL_ID_SETMASK)
#define CFG_240P_SL_EN_GETMASK        (1<<CFG_240P_SL_EN_OFFSET)
  #define CFG_240P_SL_EN_SETMASK        (1<<CFG_240P_SL_EN_OFFSET)
  #define CFG_240P_SL_EN_CLRMASK        (EXTCFG2_GETALL_MASK & ~CFG_240P_SL_EN_SETMASK)
...
#define CFG_480I_SL_METHOD_GETMASK    (1<<CFG_480I_SL_METHOD_OFFSET)
  ...
  #define CFG_480I_SL_METHOD_CLRMASK    (EXTCFG2_GETALL_MASK & ~CFG_480I_SL_METHOD_SETMASK)
#define CFG_480I_SL_ID_GETMASK        (1<<CFG_480I_SL_ID_OFFSET)
  #define CFG_480I_SL_ID_SETMASK        (1<<CFG_480I_SL_ID_OFFSET)
  #define CFG_480I_SL_ID_CLRMASK        (EXTCFG2_GETALL_MASK & ~CFG_480I_SL_ID_SETMASK)
#define CFG_480I_SL_EN_GETMASK        (3<<CFG_480I_SL_EN_OFFSET)
  #define CFG_480I_SL_EN_RSTMASK         (EXTCFG2_GETALL_MASK & ~CFG_480I_SL_EN_GETMASK)
  #define CFG_480I_SL_EN_CLRMASK         (EXTCFG2_GETALL_MASK & ~CFG_480I_SL_EN_GETMASK)

#define CFG_AUDIOCFG_GETMASK          (0x7F<<CFG_AUDIO_SPDIF_EN_OFFSET)
#define CFG_SLCFG_GETMASK             (0x1FFFFFF<<CFG_480I_SL_EN_OFFSET)



// some usefull masking
#define CFG_EXTCFG2_GETSCANLINES_MASK   (CFG_SLCFG_GETMASK)
...
#define CFG_SCALING_PAL_720_DEFAULT           ( 720 << (CFG_VERTSCALE_OFFSET-CFG_HORSCALE_OFFSET) |  800)
#define CFG_SCALING_PAL_720_DEFAULT_SHIFTED   (CFG_SCALING_PAL_720_DEFAULT << CFG_HORSCALE_OFFSET)
#define CFG_SCALING_PAL_960_DEFAULT           ( 960 << (CFG_VERTSCALE_OFFSET-CFG_HORSCALE_OFFSET) | 1040)
#define CFG_SCALING_PAL_960_DEFAULT_SHIFTED   (CFG_SCALING_PAL_960_DEFAULT << CFG_HORSCALE_OFFSET)
#define CFG_SCALING_PAL_1080_DEFAULT          (1080 << (CFG_VERTSCALE_OFFSET-CFG_HORSCALE_OFFSET) | 1200)
#define CFG_SCALING_PAL_1080_DEFAULT_SHIFTED  (CFG_SCALING_PAL_1080_DEFAULT << CFG_HORSCALE_OFFSET)
#define CFG_SCALING_PAL_1200_DEFAULT          (1200 << (CFG_VERTSCALE_OFFSET-CFG_HORSCALE_OFFSET) | 1360)
...
#define EXTCFG2_DEFAULTS            (CFG_AUDIO_AMP_DEFAULT_SETMASK | (3<<CFG_480I_SL_EN_OFFSET))
#define EXTCFG2_DEFAULTS_GETMASK    (CFG_AUDIOCFG_GETMASK | CFG_240P_SL_EN_GETMASK | CFG_480I_SL_EN_GETMASK)
