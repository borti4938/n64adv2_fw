...
#define CFG_MODE16BIT_IGR_OFFSET           7
...
#define CFG_SCALING_NTSC_240_DEFAULT_SHIFTED  (CFG_SCALING_NTSC_240_DEFAULT << CFG_HORSCALE_OFFSET) // do not care about ratio as it is masked anyway
...
#define CFG_SCALING_PAL_288_DEFAULT_SHIFTED   (CFG_SCALING_PAL_288_DEFAULT << CFG_HORSCALE_OFFSET) // do not care about ratio as it is masked anyway
