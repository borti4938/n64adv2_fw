...
#define CFG_DEINTER_MODE_DEFAULTVAL_240P       1
  #define CFG_DEINTER_MODE_DEFAULT_240P_SETMASK (CFG_DEINTER_MODE_DEFAULTVAL_240P << CFG_DEINTER_MODE_OFFSET)
...
#define EXTCFG1_DEFAULTS_240P       (CFG_RSTMASKS_DEFAULT_SETMASK | CFG_GAMMA_DEFAULT_SETMASK | \
                                     CFG_DEBLUR_MODE_SETMASK | CFG_DEINTER_MODE_DEFAULT_240P_SETMASK | CFG_TIMING_DEFAULTS_SHIFTED)
