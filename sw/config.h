...
#define EXTCFG1_DEFAULTS            (CFG_GAMMA_DEFAULT_SETMASK | CFG_DEBLUR_MODE_SETMASK | CFG_DEINTER_MODE_DEFAULT_SETMASK | CFG_TIMING_DEFAULTS_SHIFTED)
#define EXTCFG1_DEFAULTS_GETMASK    (CFG_GAMMA_GETMASK | CFG_DEBLUR_MODE_GETMASK | \
