...
#define N64ADV_INPUT_CTRL_DETECTED_OFFSET     28
#define N64ADV_HDMI_CLK_OK_OFFSET             27
#define N64ADV_INPUT_VDATA_DETECTED_OFFSET    26
#define N64ADV_INPUT_PALPATTERN_OFFSET        25
#define N64ADV_INPUT_PAL_IS_240P_OFFSET       24
...
#define N64ADV_INPUT_PAL_IS_240P_GETMASK      (1<<N64ADV_INPUT_PAL_IS_240P_OFFSET)
...
#define FALLBACKCTRL_OFFSET       3
#define FALLBACKCTRL_VALID_OFFSET 2
#define FALLBACKRST_OFFSET        1
#define FALLBACKRST_VALID_OFFSET  0

#define FALLBACK_GETALL_MASK            0xF
#define FALLBACKCTRL_GETMASK            (3<<FALLBACKCTRL_VALID_OFFSET)
  #define FALLBACKCTRL_PRESSED_GETMASK    (1<<FALLBACKCTRL_OFFSET)
  #define FALLBACKCTRL_VALID_GETMASK      (1<<FALLBACKCTRL_VALID_OFFSET)
#define FALLBACKRST_GETMASK             (3<<FALLBACKRST_VALID_OFFSET)
  #define FALLBACKRST_PRESSED_GETMASK     (1<<FALLBACKRST_OFFSET)
  #define FALLBACKRST_VALID_GETMASK       (1<<FALLBACKRST_VALID_OFFSET)

#define GAME_ID_TGL_IN_MASK         0x04
